...
-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_organizations_id_fkey" FOREIGN KEY ("organizations_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
